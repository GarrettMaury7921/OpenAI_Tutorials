...
# reads all the files in the /negative folder and generates negative.txt from them.
...
def generate_negative_description_file():
    ...
    with open('AI_Cascade_Classifier/training_output/negative.txt', 'w') as f:
        # loop over all the filenames
        for filename in os.listdir('AI_Cascade_Classifier/data/negative'):
            f.write('AI_Cascade_Classifier/data/negative/' + filename + '\n')
